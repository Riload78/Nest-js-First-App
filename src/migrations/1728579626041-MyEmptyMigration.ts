...
export class MyEmptyMigration1728579626041 implements MigrationInterface {
    name = 'MyEmptyMigration1728579626041'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_projects_access_level_enum" AS ENUM('40', '50', '20')`);
